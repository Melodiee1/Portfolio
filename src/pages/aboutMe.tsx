    ...
    return (
        <div className='AboutMe_main'>
            <div className="sec_one">
                ...
                <div className="text">
                    Introducing myself as a <u>14 year old student from Nepal</u>, Koshi (south Asia), am a student of <a href="https://www.facebook.com/pashupati.school.jhiljhile/" target='_blank'>Pashupati Academy</a> currently in grade 8. Beyond that, I'm a self taught React + Typesript Developer who likes to bring rough ideas into clean web experiences. You can navigate to my projects from the navigation bar above.
                </div> <br /> <br /> <br />
